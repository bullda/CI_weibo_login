    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="<?php echo site_url('line')?>">雪雁</a>
		  ...
		  <?php if($this->dx_auth->is_logged_in()== False){?>
            ...
            <ul class="nav">
              <li ><a href="<?php echo site_url('line')?>">首页</a></li>
              <li><a href="<?php echo site_url('line/new_line')?>">+线路</a></li>
